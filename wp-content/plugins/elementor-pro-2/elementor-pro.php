...
define( 'ELEMENTOR_PRO_VERSION', '2.9.0-beta1' );
define( 'ELEMENTOR_PRO_PREVIOUS_STABLE_VERSION', '2.8.4' );
...
function elementor_pro_load_plugin() {
	...
	$elementor_version_required = '2.9.0';
	...
	$elementor_version_recommendation = '2.9.0';
